...
# Merge the node mappings from mlx_nodes (Apple Silicon MLX backend)
from .mlx_nodes import NODE_CLASS_MAPPINGS as MLX_NODE_CLASS_MAPPINGS
from .mlx_nodes import NODE_DISPLAY_NAME_MAPPINGS as MLX_NODE_DISPLAY_NAME_MAPPINGS

NODE_CLASS_MAPPINGS.update(MLX_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(MLX_NODE_DISPLAY_NAME_MAPPINGS)
